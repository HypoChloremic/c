// `g++ cubeAuto2.cc -lglut -lGL -lGLU -o cubeAuto2`
...
void update(int value)
{
        ...
        // Interesting that we are recalling the 
        // glutTimerFunc here. . . 
        // Without it, it seemingly will not loop
        // so the first call, in `main()` starts the
        // loop
